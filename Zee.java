class Zee{
  public static void main(String[] args){
	...
	String webSeries[] = { "Abhay","Rangbaaz","Sunflower","Kaafir","Poison","State of Siege 26/11","The Final Call","Naxalbari",
        ...
        String serials[] = {"Kumkum Bhagya","Kundali Bhagya","Bhagya Lakshmi","Meet","Rabb Se Hai Dua","Jamai Raja","Jodha Akbar","Kasamh Se","Punar Vivaah",
        ...
        String realityShows[] = {"Dance India Dance","Sa Re Ga Ma Pa","India's Best Dramebaaz","DID Super Moms","DID Little Masters","Sa Re Ga Ma Pa Lil Champs",
        ...
        String zee5Movies[] = {"Uri: The Surgical Strike","The Kashmir Files","Rashmi Rocket","Dial 100","Silence","Haseen Dillruba","Radhe","Jhund",
        ...
        String zee5Telugu[] = {"ATM","Recce","Vyavastha","Dhootha","Gaalivaana","Kudi Yedamaithe","Unheard","Jhansi","Newsense","Parampara",
        ...
        String zee5Tamil[] = {"Auto Shankar","Gods of Dharmapuri","High Priestess","Thiravam","November Story","Queen","Live Telecast","Paper Rocket",
		...
		System.out.println("The third OTT platform is :" + ottName);
