class PhonePeExecutor {
    ...
    public static void main(String[] args) {
        ...
        p1.userName = "Monika";
        p1.mobileNumber = "9876543210";
        p1.upiId = "monika@upi";
        p1.bankLinked = "SBI";
        p1.appVersion = "5.0";

        History h1 = new History();
        h1.transactionId = "TXN101";
        h1.amount = 500;
        h1.receiverName = "Rahul";
        h1.paymentType = "UPI";
        h1.status = "Success";
        ...
        p2.userName = "Anjali";
        p2.mobileNumber = "9123456780";
        p2.upiId = "anjali@upi";
        p2.bankLinked = "HDFC";
        p2.appVersion = "5.1";

        History h2 = new History();
        h2.transactionId = "TXN102";
        h2.amount = 1200;
        h2.receiverName = "Kiran";
        h2.paymentType = "QR Scan";
        h2.status = "Success";
        ...
        p3.userName = "Rahul";
        p3.mobileNumber = "9988776655";
        p3.upiId = "rahul@upi";
        p3.bankLinked = "ICICI";
        p3.appVersion = "5.2";

        History h3 = new History();
        h3.transactionId = "TXN103";
        h3.amount = 300;
        h3.receiverName = "Monika";
        h3.paymentType = "UPI";
        h3.status = "Failed";
