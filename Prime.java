...
class Prime{
    ...
    static String malayalamRealityShows[] = {"BiggBossMalayalam","ComedyStars","FlowersComedy","StarSingerMalayalam",
            "UgramUjjwalam","MusicIndiaMalayalam","Super4","SellMeTheAnswer",
             "ComedyUtsavam","KitchenMagic","BumperChiri","DareTheFear",
            "LetsRock","Midukki","OnnumOnnumMoonnu",
             "NingalkkumAakamKodeswaran","D4Dance","ComedyThammil",
	...
	public static void main(String[]args){
		...
		System.out.println(" The platform is Prime :");
		
		getkannadaRealityShows();
		getteluguRealityShows();
		gethindiRealityShows();
		gettamilRealityShows();
		getenglishRealityShows();
		getmalayalamRealityShows();
		
	}
		
     static void getkannadaRealityShows(){
