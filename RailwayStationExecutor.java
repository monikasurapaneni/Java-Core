class RailwayStationExecutor {
    ...
    public static void main(String[] args) {
        ...
        p1.platformNumber = 1;
        p1.length = 600.5;
        p1.platformType = "Express";
        p1.hasShelter = true;
        p1.trainType = "Superfast";

        r1.platform = p1;
        r1.getRailwayStationDetails();

        RailwayStation r2 = new RailwayStation();
        r2.stationName = "Secunderabad";
        r2.location = "Hyderabad";
        r2.numberOfPlatforms = 8;
        r2.zone = "South Central";
        r2.stationCode = "SC";

        Platform p2 = new Platform();
        p2.platformNumber = 2;
        p2.length = 550.0;
        p2.platformType = "Passenger";
        p2.hasShelter = true;
        p2.trainType = "Local";
        ...
        p3.platformNumber = 3;
        p3.length = 700.0;
        p3.platformType = "Express";
        p3.hasShelter = false;
        p3.trainType = "Long Distance";
